...
def load_page_content(page_filename, page_title, fallback_message):
    ...
    try:
        ...
        # Try to import and run the page as a module
        # First, try to find the pages directory
        ...
        if not pages_dir:
            ...
            st.write("Searched in:", possible_pages_dirs)
            return
        ...
        try:
            ...
            st.write("📁 Available files in pages directory:", sorted(available_files))
        except Exception as e:
