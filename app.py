...
def load_leads_page():
    ...
    try:
        # Import and execute the leads page content
        import sys
        import os
        ...
        # Clear any existing page config calls and load the content
        st.markdown("### 🎯 Lead Management System")
        st.markdown("---")
        
        # Execute the leads page logic without the page config
        exec(open('pages/leads.py').read().replace('st.set_page_config(', '# st.set_page_config('))
        
    except Exception as e:
        st.error(f"Error loading leads page: {str(e)}")
        st.markdown("### 🎯 Lead Management System")
        st.info("🚧 Full leads page loading... Please check your Supabase connection.")
...
def load_analytics_page():
    ...
    try:
        ...
        # Execute the analytics page
        exec(open('pages/Analytics.py').read().replace('st.set_page_config(', '# st.set_page_config('))
        
    except Exception as e:
        st.error(f"Error loading analytics page: {str(e)}")
        st.markdown("### 📊 Advanced Analytics")
        st.info("🚧 Full analytics page loading... Please check your data connection.")
...
def load_ai_tools_page():
    ...
    try:
        ...
        exec(open('pages/ai_tools_hub.py').read().replace('st.set_page_config(', '# st.set_page_config('))
...
def load_investor_clients_page():
    ...
    try:
        ...
        # Execute the investor clients page
        exec(open('pages/investor_clients.py').read().replace('st.set_page_config(', '# st.set_page_config('))
        
    except Exception as e:
        st.error(f"Error loading investor clients page: {str(e)}")
        # Fallback to the built-in clients page
        show_clients_page()
...
def load_payment_page():
    ...
    try:
        ...
        # Execute the payment page
        exec(open('pages/9_Payment.py').read().replace('st.set_page_config(', '# st.set_page_config('))
        
    except Exception as e:
        st.error(f"Error loading payment page: {str(e)}")
        # Fallback to built-in payment page
        show_payments_page()
...
def load_settings_page():
    ...
    try:
        ...
        exec(open('pages/11_Settings.py').read().replace('st.set_page_config(', '# st.set_page_config('))
        
    except Exception as e:
        st.error(f"Error loading settings page: {str(e)}")
        # Fallback to built-in settings page
        show_settings_page()
...
def load_pipeline_page():
    ...
    try:
        ...
        # Execute the pipeline page
        exec(open('pages/pipeline_management.py').read().replace('st.set_page_config(', '# st.set_page_config('))
        
    except Exception as e:
        st.error(f"Error loading pipeline page: {str(e)}")
        st.markdown("### 📈 Pipeline Management")
...
def load_automation_page():
    ...
    try:
        ...
        # Execute the automation page
        exec(open('pages/automation_center.py').read().replace('st.set_page_config(', '# st.set_page_config('))
        
    except Exception as e:
        st.error(f"Error loading automation page: {str(e)}")
        st.markdown("### ⚙️ Automation Center")
        st.info("🚧 Full automation center loading...")
...
def load_task_management_page():
    ...
    try:
        ...
        # Execute the task management page
        exec(open('pages/task_management.py').read().replace('st.set_page_config(', '# st.set_page_config('))
        
    except Exception as e:
        st.error(f"Error loading task management page: {str(e)}")
        st.markdown("### 📋 Task Management")
        st.info("🚧 Full task management loading...")
