    ...
    with st.sidebar:
        ...
        with nav_col2:
            if st.button("📈 Pipeline", use_container_width=True):
                try:
                    st.switch_page("pages/pipeline_management.py")
                except:
        ...
        with nav_col3:
            if st.button("🧠 AI Hub", use_container_width=True):
                try:
                    st.switch_page("pages/ai_tools_hub.py")
                except:
        ...
        if st.button("💼 Investor Clients", use_container_width=True):
            try:
                st.switch_page("pages/investor_clients.py")
            except:
        ...
        with nav_col5:
            if st.button("⚙️ Automation", use_container_width=True):
                try:
                    st.switch_page("pages/automation_center.py")
                except:
                    st.info("Automation center coming soon!")
        with nav_col6:
            if st.button("📋 Tasks", use_container_width=True):
                try:
                    st.switch_page("pages/task_management.py")
                except:
                    st.info("Task management coming soon!")
        ...
        with nav_col7:
            if st.button("💰 Payment", use_container_width=True):
                try:
                    st.switch_page("pages/9_Payment.py")
                except:
